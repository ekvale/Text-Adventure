...
class VictoryTile(MapTile):
    ...
    def intro_text(self):
        living = "The sticky handed bandit has positioned himself, loafing against marble arch. " \
                 "He lurches forward with executing a lethal ginger chop. This is not your grandmas cookie."
        barrier = "Previously obstructed by the delicious villian, you discover a marble arch with a wizards seal" \
                  " blocking all entry. You spy an inscription on a nearby shrine. It reads: 'XICHULU'"
...
class TraderTile(MapTile):
    ...
    def intro_text(self):
        return """
        A frail not-quite human, not quite-not-human
        creature squats in the corner clinking his 
        gold chins together. He looks willing to trade."""
    ...
    def __init__(self, x, y):
        ...
        if r < 0.25:
            ...
            self.alive_text = "A wild Gingerbread Man appears!" \
                              ...
                              "He imprisons you in sticky residue."
            self.dead_text = "A man he was, how sweet he was," \
                             "dead err his prime, " \
...
class ItemTile(MapTile):
    def __init__(self, x, y):
        lst = [items.blackMagicSword(), items.ironaxe(), items.HealingPotion(), items.sharpStick(),
               items.ScrollofHealingArmor(), items.ironaxe(), items.CrustyBread()]
              ...
              You see the confectioner as he replies,
               "If we took the bones out it wouldn't be crunchy now, would it?"
                You see a box of "Crunchy Frog" chocolates,
                  ...
                  *************************************************************
                  An disfigured goblin fades in and out existance in the corner. He whistles at you."""
...
class EightTile(MapTile):
    ...
    def intro_text(self):
        if self.quest_claimed:
            ...
            return"""A few lit candles, and some a turned over table and chairs... and not much more...
             *********************************************************************************************
             There is small ghostly outline of a goblin-like creature in the corner. He beacons you over..."""
...
class SixTile(MapTile):
    ...
    def intro_text(self):
        ...
        own breath. There is a floating mirror in the center of the room.
        """
